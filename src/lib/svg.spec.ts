...
describe('SvgPath', () => {
  ...
  it('should decode and rencode the sword path', () => {
    const svg = new SvgPath(swordPath);
  ...
  it('should merge lines', () => {
    expect(new SvgPath(`m 0 0 l 1 1 l 1 2`).asString(3, true)).toEqual(`m0 0 1 1 1 2`);
    expect(new SvgPath(`M 0 0 L 1 1 L 1 2`).asString(3, true)).toEqual(`M0 0 1 1 1 2`);
    expect(new SvgPath(`m 0 0 L 1 1 l 1 2 l 3 3`).asString(3, true)).toEqual(`m0 0L1 1l1 2 3 3`);
    expect(new SvgPath(`M 0 0 l 1 1 L 1 2 L 3 3`).asString(3, true)).toEqual(`M0 0l1 1L1 2 3 3`);
    expect(new SvgPath(`m 0.1 0.2 l 0.6 0.5 l 0.3 0.4`).asString(3, true)).toEqual(`m.1.2.6.5.3.4`);
  });
  ...
  it('should merge consecutive commands', () => {
    ...
    expect(new SvgPath(path).asString(3, true)).toEqual(minifiedPath);
  });
});